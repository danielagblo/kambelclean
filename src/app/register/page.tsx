    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-[#F9F9F9] rounded-2xl shadow-xl p-8 border border-gray-100">
          <h2 className="text-3xl font-bold text-[#374957] mb-2 text-center">Register your business!</h2>
          <p className="text-sm text-[#374957] mb-6 text-center">Registration is ongoing</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-9 pr-3 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="block w-full pl-3 pr-10 py-3 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-white"
                required
              >
            ...
            <button
              ...
              className="w-full bg-green-600 text-white py-3 px-4 rounded-lg text-sm font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="mt-6">
            <a
              ...
              className="w-full flex items-center justify-center gap-2 bg-green-600 text-white py-3 px-4 rounded-lg text-sm font-medium hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors"
            >
          ...
          {/* Additional Info */}
          <div className="mt-8 space-y-3 text-sm text-[#374957]">
